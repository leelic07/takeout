<template>
    <el-row class="member-management-container">
        ...
        <el-row>
            ...
            <el-col :span="5" class="member-select">
                <el-input placeholder="请输入收货地址" v-model="orderNumber"></el-input>
            </el-col>
        ...
        <el-row class="order-statics">
            <el-table :data="orderList" stripe border style="width: 100%">
                ...
                <el-table-column prop="phone" label="积分"></el-table-column>
                ...
                <el-table-column prop="phone" label="订单数"></el-table-column>
                <el-table-column prop="phone" label="消费额"></el-table-column>
