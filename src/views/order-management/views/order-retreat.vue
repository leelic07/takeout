                  ...
                  <el-form :model="props.row"
                    ...
                    <el-form-item>
                      <el-button type="danger"
                        ...
                        v-if="props.row.orders.isRefund === 0 && type !== '1'">取消订单并退款</el-button>
                      <el-button type="danger"
                        plain
                        size="mini"
                        @click="partCancelOrder(props.row)"
                        v-if="props.row.orders.isRefund === 0 && type !== '1'">部分退款</el-button>
