  ...
  <el-row class="goods-management-container">
    ...
    <el-row class="order-statics">
      <el-table :data="orderList" stripe border fit style="width: 100%">
        ...
        <el-table-column prop="activityCategory" label="活动类型"></el-table-column>
        <el-table-column prop="activityNumber" label="活动编号"></el-table-column>
        <el-table-column prop="name" label="活动名称"></el-table-column>
        <el-table-column prop="createdAt" label="开始日期"></el-table-column>
        <el-table-column prop="endedAt" label="活动结束日期">
        </el-table-column>
        <el-table-column prop="participant" label="活动参与人数"></el-table-column>
        <el-table-column prop="discountMoney" label="优惠券金额"></el-table-column>
        <el-table-column prop="discountTotal" label="优惠券总数"></el-table-column>
        <el-table-column prop="discountRemain" label="优惠券余量"></el-table-column>
        <el-table-column prop="activityQuantity" label="活动核销数"></el-table-column>
