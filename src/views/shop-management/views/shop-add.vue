            ...
            <el-card>
                <el-form :model="shopInfo" ref="shopForm" :rules="rule" size="large">
                    ...
                    <el-form-item label="店铺经度" label-width="120px" prop="lat">
                        <el-input v-model="shopInfo.lat" auto-complete="off" placeholder="请填写店铺经度">
                            <template slot="append">度</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="店铺维度" label-width="120px" prop="lng">
                        <el-input v-model="shopInfo.lng" auto-complete="off" placeholder="请填写店铺维度">
                            <template slot="append">度</template>
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="起送价" label-width="120px" prop="startingPrice">
                        <el-input v-model="shopInfo.startingPrice" auto-complete="off" placeholder="请填写起送价">
                    ...
                    <el-form-item label="配送费" label-width="120px" prop="distributionFee">
                        <el-input v-model="shopInfo.distributionFee" auto-complete="off" placeholder="请填写配送费">
                            <template slot="append">元</template>
                        </el-input>
                    </el-form-item>
